      ...
      <div className="container">
        ...
        <div className="item">
          ...
          <div className="user">
            <div className="userInfo">
              <img
                src="https://cdn.shopify.com/s/files/1/0045/5104/9304/files/AC-Styling-Tile-800x800.jpg?v=1675871662"
                alt=""
              />
              <div className="online" />
                <span>Marc </span>
          ...
          <div className="user">
            <div className="userInfo">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSm9LxRVgjGvfNQ-sbw63HQ0kXtqW07FAMEpQ&usqp=CAU"
                alt=""
              />
              <div className="online" />
                <span>Artur </span>
